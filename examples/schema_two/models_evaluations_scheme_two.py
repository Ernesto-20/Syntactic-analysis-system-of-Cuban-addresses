...
from tools.compare_results import calculate_results_two
from tools.decoder import Decoder
from tools.neural_parser_manage import NeuralParserManage
...
address_parser = AddressParser(model_data_high, Decoder(model_data_high.data.get_id_to_category(),
                                                        AddressCleaner.cleaner_method('custom_standardization')))

result_list = address_parser.process_address_two(real_addresses['full_address'].to_list())
