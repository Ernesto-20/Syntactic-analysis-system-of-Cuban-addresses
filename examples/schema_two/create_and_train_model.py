...
data_set = DataSetManage.load(f'../../assets/default_data_set/model_type_two/{tp}_S2_{address}')
...
# save
NeuralParserManage.save_neural_parser(model, route='../../assets/trained_models/model_type_two',
                                      name='modelo_prueba')
print('Finish')