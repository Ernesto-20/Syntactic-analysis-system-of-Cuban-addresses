...
class DataSetAdapter:
    ...
    def adapt(data_set: DataFrame, training_percentage: float, validation_percentage: float,
        ...
        val_features_sentence = DataSetAdapter._get_sentence(val_features)
        ...
        train_targets = DataSetAdapter._get_tags(train_targets, n_tag, max_len_word)
        test_targets = DataSetAdapter._get_tags(test_targets, n_tag, max_len_word)
        val_targets = DataSetAdapter._get_tags(val_targets, n_tag, max_len_word)
    ...
    @staticmethod
    def _get_tags(data, n_tag, max_len):
        value = n_tag-1
