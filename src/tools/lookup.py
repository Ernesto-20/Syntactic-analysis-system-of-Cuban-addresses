STREET_NAME_PREFIX = ['calle', 'CALL', 'ave', 'avenida', 'ave.', 'Ave', 'Ave.', 'AVE', 'AVE.', 'carretera', 'ctra', 'Ctra.', 'Ctra', 'carr',
                      'Carr.', 'Carr', 'carret', 'Carret.', 'Carret', 'CARRET', 'CARRETE', 'calzada', 'czda.', 'calz', 'Calzada', 'Czda',
                      'Calz', 'czda.', 'calz.', 'Czda.', 'Calz.', 'pasaje', 'psje', 'callejon',  'cjon', 'callejuela', 'acera', 'terraplan', 'terr', 'Terraplen', 'camino']
...
DISTANCE_PREFIX = ['Km.', 'KM.', 'Km', 'KM', 'K.', 'k.', 'kilometro', 'Kilometro', 'KILOMETRO', 'K\M', 'K/M', 'k/m', 'k\m']
LOCALITY_PREFIX = ['pueblo', 'pue', 'Pueblo', 'poblado', 'pob', 'Poblado', 'caserio', 'cas', 'csrio', 'Caserio', 'batey', 'bat', 'ciudad',
                   'reparto', 'rpto', 'rto', 'Reparto', 'rpto.', 'rto.', 'Rpto.', 'Rto.', 'barrio', 'barr', 'bo', 'Barr', 'Barr.', 'Bo.',
                   'BRRI', 'comunidad', 'com', 'Comunidad', 'Com', 'Com.', 'distrito' 'dist', 'Distrito', 'Dist', 'Dist.',
                  'finca', 'Finca', 'Zona', 'zona']
MUNICIPALITY_PREFIX = ['Mun.', 'mun.', 'Mun', 'mun', 'Municipio', 'municipio', 'MUNICIPIO']
PROVINCE_PREFIX = ['Prov.', 'prov.', 'PROV.', 'Prov', 'prov', 'Provincia', 'provicia', 'PROVINCIA', 'Pro.', 'PRO.', 'Pro', 'PRO', 'pro']
BUILDING_SUBDIVISION_PREFIX = ['apto', 'bloque', 'blq', 'esc', 'escalera', 'piso', 'Apto', 'apartamento', 'Bloque', 'apto.', 'Apto.', 'apart', 'APTO', 'ESC']
CONJUNTION = ['y', 'e']
